...
export interface WrapMRC721UpgradeableInterface extends utils.Interface {
  functions: {
...
export interface WrapMRC721Upgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WrapMRC721UpgradeableInterface;
