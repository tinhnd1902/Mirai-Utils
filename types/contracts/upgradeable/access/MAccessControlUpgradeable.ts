...
export interface MAccessControlUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface MAccessControlUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MAccessControlUpgradeableInterface;
