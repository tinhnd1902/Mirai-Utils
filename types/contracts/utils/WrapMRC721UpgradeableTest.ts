...
export interface WrapMRC721UpgradeableTestInterface extends utils.Interface {
  functions: {
...
export interface WrapMRC721UpgradeableTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WrapMRC721UpgradeableTestInterface;
