        ...
        <div className="card-body mw-800px py-20">
          ...
          <div className="row mb-8">
            ...
            <div className="col-lg-9">
              ...
              <div className="form-text">
                After you log in, you will be asked for additional information to confirm your identity and protect your
          ...
          <div className="row mb-13">
            ...
            <div className="col-lg-9">
              ...
              <div className="form-text py-2">
                For extra security, this requires you to confirm your email or phone number when you reset your
                password.
