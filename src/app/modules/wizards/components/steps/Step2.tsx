          ...
          <label className="d-flex flex-stack mb-5 cursor-pointer">
            <span className="d-flex align-items-center me-2">
              ...
              <span className="d-flex flex-column">
                ...
                <span className="fs-6 fw-bold text-gray-500">Use images to enhance your post flow</span>
              </span>
            </span>
          ...
          <label className="d-flex flex-stack mb-0 cursor-pointer">
            <span className="d-flex align-items-center me-2">
              ...
              <span className="d-flex flex-column">
                ...
                <span className="fs-6 fw-bold text-gray-500">Use images to enhance time travel rivers</span>
              </span>
            </span>
